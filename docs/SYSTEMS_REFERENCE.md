...
## 28. Nation Agendas — "The Designs of the Powers" (NA-0..NA-3 landed July 17, 2026; NA-5 + NA-6a/6b July 18, 2026; NA-6c July 19, 2026)

**Spec:** `docs/NATION_AGENDAS_SPEC.md` (§0 gate record; §12/§13/§14/§16/§17/§20 landing records authoritative). **Core:** `backend/game_logic/agendas.py` (derivation) + `backend/game_logic/formations.py` (NA-6 formation, creation, identity). **Tests:** `test_nation_agendas.py` (168) + `test_nation_agendas_ultimatums.py` (35) + `test_nation_agendas_formables.py` (179).
