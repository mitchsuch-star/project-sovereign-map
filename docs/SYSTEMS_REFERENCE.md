...
## 28. Nation Agendas — "The Designs of the Powers" (NA-0..NA-3 landed July 17, 2026; NA-5 July 18, 2026)

**Spec:** `docs/NATION_AGENDAS_SPEC.md` (§0 gate record; §12/§13/§14/§16 landing records authoritative). **Core:** `backend/game_logic/agendas.py`. **Tests:** `test_nation_agendas.py` (168) + `test_nation_agendas_ultimatums.py` (35).
