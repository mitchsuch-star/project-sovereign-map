...
4. Participants: compact "Your side" and "Their side" rows with `standing_display`, material share, and one outcome stamp: `leader`, `rewarded`, `consulted`, `shut out`, `sold out`, or `ignored`. This appears before terms so the player sees who is being rewarded, sold out, forced into alignment, or ignored before parsing clause details.
