...
> **Historical note (April 22, 2026):** The pre-B-Hegemony repo-reality warning is superseded by the April 28 landed-state note above. Keep this paragraph only as chronology; implementers should follow the April 28 repo reality and the live code.
