...
- `hegemony_relaxation_bands_fired: Set[int]` — surfaced bands whose downward relaxation aside has already fired in the current equilibrium epoch (`2` = alarming, `3` = crisis); cleared below `33%`; serialized through save/load
