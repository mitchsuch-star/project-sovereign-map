...
| 8.5 | Events, Goals & National Identity | **▶ IN PROGRESS** — **Batch Q Chunk 1 ✅ LANDED July 16, 2026** (S5-1/2/3/5 + S5-4 docstring + AUD-g/AUD-e; `tests/test_batch_q_fixes.py`, suite 13,590/3 — see STATUS top entry). Remaining Batch Q: VS-5 live exercise, AUD-b armistice guard, AUD-c war-score-aware offers, E7/Metternich small builds → CR-6 mini-gate → the 8.5 design gate (Nation Agendas core); see the 8.EVAL record §3 |
