...
> variance is the build (now position 8) — everything cheap and loud lands before it so
> Round 0 tests a game with sound, a working economy, and marshals who speak.
