...
| **National Goals** | AI nation intent + formables ("Redeem Italy", the Risorgimento formation; "Unite Germany" REJECTED as post-period) | Medium | **SPECCED July 17, 2026** — `NATION_AGENDAS_SPEC.md` v1.1 (NA-0..3 core + NA-5 ultimatums + NA-6 Formable Dreams; Free Ireland → DEF-5); player-France goals → Pre-Ship Victory & Objectives Pass (agenda-substrate seed, spec §9) |
