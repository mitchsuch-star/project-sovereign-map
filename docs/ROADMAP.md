...
**Open design decisions parked for the user:** EC-2 sink set · EC-5 Continental System upgrade-vs-trim · EC-6/DG-5 victory conditions · MC-1 ability set · MC-4 personality types · CR-6 gate (CR-5 scope BLESSED July 5, 2026 — spec §6) · DEF-12 map modes · Jealousy v3.1 (after MC + v3.2 addendum). *(The Slice H gate was approved + landed July 3, 2026.)*
