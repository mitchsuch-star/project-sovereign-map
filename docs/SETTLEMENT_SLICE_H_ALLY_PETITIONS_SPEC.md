...
> **Status:** DRAFT v0.1 — **NEEDS USER DESIGN GATE. DO NOT CODE.** (Per the SC-32 deferred sub-outcome row in `SETTLEMENT_UI_CLEANUP_SPEC.md` ~line 55: Slice H requires a dedicated spec + user approval before either petition type may appear in any source file.)
> **Date:** July 2, 2026
