...
| EC-U1 upkeep (establishment) | ✅ **LANDED July 14, 2026** | net non-regressive under attrition | `0997eac` + `2ce1f1d` |
| EC-U2 gold sink (infrastructure) | ✅ **LANDED July 14, 2026** | conquest-free sink reachable | `0997eac` |
| **Sweep 3 (Half B)** | ✅ **RAN July 14, 2026** | Economy 5.0→**6.0** (short of 6.5); 0 regressions | `SWEEP_3_2026_07_14.md` |
