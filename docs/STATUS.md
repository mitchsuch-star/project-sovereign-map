...
| **Current Phase** | **Peace Deals — Ally Participation spec v1.6 / implementation plan v1.3 READY FOR SLICE A (April 28, 2026).** BPH-A through BPH-D, WPS-A through WPS-D, WB-A, WB-B, WB-C, and WB-D all landed. `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` now own the full-Europe handoff after combined audit closure; coding may start with Slice A. Map-readiness non-art closure remains complete and art-blocked only. |
...
**Next diplomacy workflow:** **War Bargains COMPLETE (WB-A through WB-D).** BPH-A through BPH-D + WPS-A through WPS-D + WB-A/WB-B/WB-C/WB-D all landed. Gate 1 passed. `threat_coalition` merged into `balance_of_europe`. War Bargains track fully closed. See `docs/PEACE_DEALS_UMBRELLA_SPEC.md` for remaining Peace Deals items.
...
| 4 | Ally Participation + Common Peace | ally beneficiaries, contribution / consultation rights, common peace routing, settlement fallout | Post-bargains track. `docs/WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.6 and implementation plan v1.3 own the full-Europe handoff; next work is Slice A. |
...
**Peace Deals spec gate (Apr 28):** BPH-A through BPH-D, WPS-A through WPS-D, and WB-A through WB-D are landed. Ally Participation/Common Peace now has `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.6 and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` v1.3 covering full-Europe scale after combined audit closure; next is Slice A coding.
