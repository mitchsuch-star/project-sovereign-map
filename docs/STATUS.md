...
| **Current Phase** | **Peace Deals - Ally Participation spec v1.16 / implementation plan v1.13 READY FOR SLICE A1 (April 29, 2026).** BPH-A through BPH-D, WPS-A through WPS-D, WB-A, WB-B, WB-C, and WB-D all landed. `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` now own the full-Europe handoff after combined Codex/Claude synthesis, implementation-seam closure, full-map settlement-audit fixes, Claude reconciliation closure, v1.13 full-Europe risk pass, v1.14 codebase synthesis closure, v1.15 audit closure, and v1.16 full-Europe audit synthesis closure; coding may start with Slice A1. Map-readiness non-art closure remains complete and art-blocked only. |
...
| 4 | Ally Participation + Common Peace | ally beneficiaries, contribution / consultation rights, common peace routing, settlement fallout | Post-bargains track. `docs/WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.16 and implementation plan v1.13 own the full-Europe handoff; next work is Slice A1. |
...
**Peace Deals spec gate (Apr 29):** BPH-A through BPH-D, WPS-A through WPS-D, and WB-A through WB-D are landed. Ally Participation/Common Peace now has `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.16 and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` v1.13 covering full-Europe scale after combined Codex/Claude synthesis, implementation-seam closure, full-map settlement-audit fixes, Claude reconciliation closure, v1.13 full-Europe risk pass, v1.14 codebase synthesis closure, v1.15 audit closure, and v1.16 full-Europe audit synthesis closure; next is Slice A1 coding.
