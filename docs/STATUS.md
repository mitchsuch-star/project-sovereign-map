...
| **Current Phase** | **Peace Deals - Ally Participation spec v1.24 / implementation plan v1.21 READY FOR SLICE A1 FOUNDATION GATE (May 1, 2026).** BPH-A through BPH-D, WPS-A through WPS-D, WB-A, WB-B, WB-C, and WB-D all landed. `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` now own the full-Europe handoff through mapped-nation A1 simplification, future-nation onboarding hardening, active-roster fixture closure, C2 settlement-dialogue serialization closure, explicit common-peace tuning escalation, forced-alliance common-peace pair lifecycle, a hard full-Europe narrow/full/serial incentive gate, compact/medium/verbose settlement-review fallbacks, AI-defender viability and war-exhaustion exploit fixtures, `settlement_gratitude_mod` intent, Slice E awe set-piece targets, pre-D1 comprehension gate, A3 post-merge invariant assertions, pre-A2 `CascadeContext` guidance, B2 `record_battle()` ordering guard, concrete `request_revision` behavior, and D2 cross-war profiling. Coding may start with Slice A1 only by first landing the foundation gate: mapped-nation capital helper safety, settlement containers, old-save defaults, empty index/cache scaffolding, cache invalidation hooks, 20-`war_instance` cache/index proof, and no behavioral common-peace work. Map-readiness non-art closure remains complete and art-blocked only. |
...
| 4 | Ally Participation + Common Peace | ally beneficiaries, contribution / consultation rights, common peace routing, settlement fallout | Post-bargains track. `docs/WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.24 and implementation plan v1.21 own the full-Europe handoff; next work is Slice A1 foundation gate. |
...
**Peace Deals spec gate (May 1):** BPH-A through BPH-D, WPS-A through WPS-D, and WB-A through WB-D are landed. Ally Participation/Common Peace now has `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.24 and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` v1.21 covering full-Europe scale after combined Codex/Claude synthesis through the mapped-nation A1 simplification, final scale-audit hardening, future-nation onboarding hardening, active-roster fixture closure, C2 settlement-dialogue serialization closure, explicit common-peace tuning escalation, forced-alliance common-peace pair lifecycle, hard full-Europe narrow/full/serial incentive proof, compact/medium/verbose settlement-review fallbacks, AI-defender viability and war-exhaustion exploit fixtures, `settlement_gratitude_mod` intent, Slice E awe set-piece targets, a spec-naive manual pre-D1 settlement-review comprehension gate, A3 post-merge invariant assertions, pre-A2 `CascadeContext` guidance, a B2 `record_battle()` ordering guard, concrete `request_revision` behavior, and D2 cross-war profiling. Next is Slice A1 foundation coding: mapped-nation capital helper safety, settlement containers, old-save defaults, empty index/cache scaffolding, cache invalidation hooks, and 20-`war_instance` cache/index proof before any A2/B/C/D behavior.
