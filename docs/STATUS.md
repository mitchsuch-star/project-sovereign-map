...
| **Current Phase** | **Peace Deals — Ally Participation spec v1.12 / implementation plan v1.9 READY FOR SLICE A (April 29, 2026).** BPH-A through BPH-D, WPS-A through WPS-D, WB-A, WB-B, WB-C, and WB-D all landed. `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` now own the full-Europe handoff after combined Codex/Claude synthesis, implementation-seam closure, full-map settlement-audit fixes, and Claude reconciliation closure; coding may start with Slice A. Map-readiness non-art closure remains complete and art-blocked only. |
...
| 4 | Ally Participation + Common Peace | ally beneficiaries, contribution / consultation rights, common peace routing, settlement fallout | Post-bargains track. `docs/WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.12 and implementation plan v1.9 own the full-Europe handoff; next work is Slice A. |
...
**Peace Deals spec gate (Apr 29):** BPH-A through BPH-D, WPS-A through WPS-D, and WB-A through WB-D are landed. Ally Participation/Common Peace now has `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.12 and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` v1.9 covering full-Europe scale after combined Codex/Claude synthesis, implementation-seam closure, full-map settlement-audit fixes, and Claude reconciliation closure; next is Slice A coding.
