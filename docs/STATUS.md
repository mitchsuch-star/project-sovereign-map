...
| **Current Phase** | **Peace Deals - Ally Participation spec v1.20 / implementation plan v1.17 READY FOR SLICE A1 FOUNDATION GATE (April 29, 2026).** BPH-A through BPH-D, WPS-A through WPS-D, WB-A, WB-B, WB-C, and WB-D all landed. `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` now own the full-Europe handoff after combined Codex/Claude synthesis through mapped-nation A1 simplification and future-nation onboarding hardening. Coding may start with Slice A1 only by first landing the foundation gate: mapped-nation capital helper safety, settlement containers, old-save defaults, empty index/cache scaffolding, cache invalidation hooks, and no behavioral common-peace work. Map-readiness non-art closure remains complete and art-blocked only. |
...
| 4 | Ally Participation + Common Peace | ally beneficiaries, contribution / consultation rights, common peace routing, settlement fallout | Post-bargains track. `docs/WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.20 and implementation plan v1.17 own the full-Europe handoff; next work is Slice A1 foundation gate. |
...
**Peace Deals spec gate (Apr 29):** BPH-A through BPH-D, WPS-A through WPS-D, and WB-A through WB-D are landed. Ally Participation/Common Peace now has `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.20 and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` v1.17 covering full-Europe scale after combined Codex/Claude synthesis through the mapped-nation A1 simplification, final scale-audit hardening, and future-nation onboarding hardening. Next is Slice A1 foundation coding: mapped-nation capital helper safety, settlement containers, old-save defaults, empty index/cache scaffolding, cache invalidation hooks, and no off-map nation model before any A2/B/C/D behavior.
