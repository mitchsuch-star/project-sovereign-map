...
> **Last Updated:** April 29, 2026 (**IMPERIAL SETTLEMENT SPEC v1.14 CODEBASE SYNTHESIS READY** - `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md`, `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md`, and `DIPLOMACY_SPEC.md` are aligned after the latest Claude/Codex codebase synthesis. Closure hardening now treats live `NATION_CAPITALS["Britain"] = "Netherlands"` as a proxy holding rather than a true settlement capital, explicitly owns raw treaty harshness in `diplomatic_templates.py`, splits Slice B into B1/B2/B3 gates, adds a mailbox label contract for `incoming_settlement_offer`, previews uncapped multi-forced-alliance threat spikes, defines sold-out/anti-renewal posture-gate precedence, and adds AI defender-objective tuning coverage.)
...
| **Current Phase** | **Peace Deals - Ally Participation spec v1.14 / implementation plan v1.11 READY FOR SLICE A1 (April 29, 2026).** BPH-A through BPH-D, WPS-A through WPS-D, WB-A, WB-B, WB-C, and WB-D all landed. `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` now own the full-Europe handoff after combined Codex/Claude synthesis, implementation-seam closure, full-map settlement-audit fixes, Claude reconciliation closure, v1.13 full-Europe risk pass, and v1.14 codebase synthesis closure; coding may start with Slice A1. Map-readiness non-art closure remains complete and art-blocked only. |
...
**Next diplomacy workflow:** **Ally Participation / Common Peace Slice A1.** BPH-A through BPH-D + WPS-A through WPS-D + WB-A/WB-B/WB-C/WB-D all landed. Gate 1 passed. `threat_coalition` merged into `balance_of_europe`. War Bargains track fully closed. The historical Peace Deals umbrella remains for cross-cutting context; active settlement work starts from `docs/WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md`.
...
| 4 | Ally Participation + Common Peace | ally beneficiaries, contribution / consultation rights, common peace routing, settlement fallout | Post-bargains track. `docs/WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.14 and implementation plan v1.11 own the full-Europe handoff; next work is Slice A1. |
...
**Peace Deals spec gate (Apr 29):** BPH-A through BPH-D, WPS-A through WPS-D, and WB-A through WB-D are landed. Ally Participation/Common Peace now has `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.14 and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` v1.11 covering full-Europe scale after combined Codex/Claude synthesis, implementation-seam closure, full-map settlement-audit fixes, Claude reconciliation closure, v1.13 full-Europe risk pass, and v1.14 codebase synthesis closure; next is Slice A1 coding.
