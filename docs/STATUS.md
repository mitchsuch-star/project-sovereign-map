...
| **Current Phase** | **Peace Deals - Ally Participation spec v1.17 / implementation plan v1.14 READY FOR SLICE A1 FOUNDATION GATE (April 29, 2026).** BPH-A through BPH-D, WPS-A through WPS-D, WB-A, WB-B, WB-C, and WB-D all landed. `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` now own the full-Europe handoff after combined Codex/Claude synthesis, implementation-seam closure, full-map settlement-audit fixes, Claude reconciliation closure, v1.13 full-Europe risk pass, v1.14 codebase synthesis closure, v1.15 audit closure, v1.16 full-Europe audit synthesis closure, and v1.17 pre-A1 foundation-gate reconciliation. Coding may start with Slice A1 only by first landing the foundation gate: off-map helper APIs, settlement containers, old-save defaults, empty index/cache scaffolding, and off-map elimination protection. Map-readiness non-art closure remains complete and art-blocked only. |
...
| 4 | Ally Participation + Common Peace | ally beneficiaries, contribution / consultation rights, common peace routing, settlement fallout | Post-bargains track. `docs/WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.17 and implementation plan v1.14 own the full-Europe handoff; next work is Slice A1 foundation gate. |
...
**Peace Deals spec gate (Apr 29):** BPH-A through BPH-D, WPS-A through WPS-D, and WB-A through WB-D are landed. Ally Participation/Common Peace now has `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.17 and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` v1.14 covering full-Europe scale after combined Codex/Claude synthesis, implementation-seam closure, full-map settlement-audit fixes, Claude reconciliation closure, v1.13 full-Europe risk pass, v1.14 codebase synthesis closure, v1.15 audit closure, v1.16 full-Europe audit synthesis closure, and v1.17 pre-A1 foundation-gate reconciliation. Next is Slice A1 foundation coding: off-map helpers, settlement containers, old-save defaults, empty index/cache scaffolding, and off-map elimination protection before any A2/B/C/D behavior.
