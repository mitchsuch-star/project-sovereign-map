...
| **Current Phase** | **Peace Deals — Ally Participation spec v1.2 READY FOR IMPLEMENTATION-PLAN WRITEUP (April 28, 2026).** BPH-A through BPH-D, WPS-A through WPS-D, WB-A, WB-B, WB-C, and WB-D all landed. `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` now owns the full-Europe design fixes and remains NO-GO for coding until the implementation plan is written. Map-readiness non-art closure remains complete and art-blocked only. |
...
| 4 | Ally Participation + Common Peace | ally beneficiaries, contribution / consultation rights, common peace routing, settlement fallout | Post-bargains track. `docs/WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.2 now owns the full-Europe design contract; next artifact is the implementation plan, then Slice A. |
...
**Peace Deals spec gate (Apr 28):** BPH-A through BPH-D, WPS-A through WPS-D, and WB-A through WB-D are landed. Ally Participation/Common Peace now has `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.2 covering full-Europe scale; next is a dedicated implementation plan before Slice A coding.
