...
- **Phase 6.5 remaining** — Map Renderer cutover only. Placeholder bitmap/color-map lookup and Camera2D cutover are live; commissioned art-backed layers plus final Godot smoke validation still remain. Tutorial deferred to Pre-EA.
