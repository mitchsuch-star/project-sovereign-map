...
| **Current Phase** | **Peace Deals — Ally Participation spec v1.10 / implementation plan v1.7 READY FOR SLICE A (April 28, 2026).** BPH-A through BPH-D, WPS-A through WPS-D, WB-A, WB-B, WB-C, and WB-D all landed. `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` now own the full-Europe handoff after combined Codex/Claude synthesis, implementation-seam closure, and full-map settlement-audit fixes; coding may start with Slice A. Map-readiness non-art closure remains complete and art-blocked only. |
...
| 4 | Ally Participation + Common Peace | ally beneficiaries, contribution / consultation rights, common peace routing, settlement fallout | Post-bargains track. `docs/WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.10 and implementation plan v1.7 own the full-Europe handoff; next work is Slice A. |
...
**Peace Deals spec gate (Apr 28):** BPH-A through BPH-D, WPS-A through WPS-D, and WB-A through WB-D are landed. Ally Participation/Common Peace now has `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` v1.10 and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md` v1.7 covering full-Europe scale after combined Codex/Claude synthesis, implementation-seam closure, and full-map settlement-audit fixes; next is Slice A coding.
