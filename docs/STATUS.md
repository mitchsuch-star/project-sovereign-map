...
| **Current Phase** | **Peace Deals — War Bargains COMPLETE (April 27, 2026).** BPH-A through BPH-D, WPS-A through WPS-D, WB-A, WB-B, WB-C, and WB-D all landed (~160 tests). `threat_coalition` merged into `balance_of_europe`. War Bargains track fully closed. Map-readiness non-art closure remains complete and art-blocked only. |
