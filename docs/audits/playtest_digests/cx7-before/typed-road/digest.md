...
- platform: CPython 3.13.12 · Windows-11-10.0.22000-SP0 (AMD64) · PYTHONHASHSEED `0` · engine `unknown` (dirty: unknown) · content `3d2c357fb3cd` · driver `641a9fcf2c43`
...
- CMD `quickly attack Mack` → ✗ There is no 'quickly' in the order of battle, Sire. Whom did you intend?
- CMD `immediately attack Mack` → ✗ There is no 'immediately' in the order of battle, Sire. Whom did you intend?
- CMD `ok retreat` → ✗ There is no 'ok' in the order of battle, Sire. Whom did you intend?
...
- CMD `someone attack Mack` → ✗ There is no 'someone' in the order of battle, Sire. Whom did you intend?
...
- CMD `cavalry attack Mack` → ✗ There is no 'cavalry' in the order of battle, Sire. Whom did you intend?
- CMD `guards attack Mack` → ✗ There is no 'guards' in the order of battle, Sire. Whom did you intend?
- CMD `Marshal attack Mack` → ✗ There is no 'Marshal' in the order of battle, Sire. Whom did you intend?
- CMD `anyone scout Swabia` → ✗ There is no 'anyone' in the order of battle, Sire. Whom did you intend?
- CMD `right, attack Mack` → ✗ There is no 'right' in the order of battle, Sire. Whom did you intend?
...
- CMD `Zorglub pull back` → ✗ No marshals are in danger. None need to retreat.
- CMD `Zorglub recon Swabia` → ✓ Soult scouts Swabia: Controlled by Austria. Terrain: Plains. No enemy forces detected.
- CMD `all marshals, attack` → ✗ There is no 'all marshals' in the order of battle, Sire. Whom did you intend?
- CMD `whoever is closest attack Mack` → ✗ There is no 'whoever is closest' in the order of battle, Sire. Whom did you intend?
- CMD `well retreat` → ✗ There is no 'well' in the order of battle, Sire. Whom did you intend?
...
- CMD `Ney attack Mack?` → ✓ Berthier sets down his pen. "I cannot answer that from the dispatches, Sire."
- CMD `Davout fortify?` → ✓ Berthier sets down his pen. "I cannot answer that from the dispatches, Sire."
- CMD `Soult scout Swabia?` → ✓ Berthier sets down his pen. "I cannot answer that from the dispatches, Sire."
- CMD `Murat drill?` → ✓ Berthier sets down his pen. "I cannot answer that from the dispatches, Sire."
