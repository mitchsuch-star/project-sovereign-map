# Playtest digest — ge3-pressburg-austerlitz
...
- played: board `The Third Coalition, 1805` · map `europe` (126 provinces) · France from turn 28 · campaign seed `historical` · dice `austerlitz`
