# Playtest digest — cx-before-historical
...
- enemy phase: 1 actions, 0 attacks — Britain, Russia, Austria and 6 other courts stirred as well, but their formations remain beyond our sight.
  ...
  - POPUP proposal_result: Tyrol is ceded to the Kingdom of Italy. Loyalty +10 (86 → 96); bond 0 → 20 (+1 a turn). Cost: 1 DP. Our net falls by 1g a turn — 89g of income forfeited, 30g of occupation relieved, 66g returned as tribute at today's 75% rate, the force limit falls 2,500 (+8g surcharge). → display-only
...
---
finished: **completed** · commands 200 · popups 37 · battles 9
