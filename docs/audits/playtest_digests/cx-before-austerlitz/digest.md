# Playtest digest — cx-before-austerlitz
...
- platform: CPython 3.13.12 · Windows-11-10.0.22000-SP0 (AMD64) · PYTHONHASHSEED `0` · engine `f70085825bf5` · content `cde3b42fa9cf` · driver `641a9fcf2c43`
...
- enemy phase: 2 actions, 0 attacks — Britain, Russia, Prussia and 5 other courts stirred as well, but their formations remain beyond our sight.
  ...
  - POPUP proposal_result: Tyrol is ceded to the Kingdom of Italy. Loyalty +10 (88 → 98); bond 0 → 20 (+1 a turn). Cost: 1 DP. Our net rises by 4g a turn — 101g of income forfeited, 30g of occupation relieved, 75g returned as tribute at today's 75% rate, the force limit falls 2,500 at no cost today. → display-only
...
## Turn 16 — Early May 1806
  ...
  - POPUP proposal_result: The Kingdom of Italy's tribute is remitted for 8 collections (3896g forgone). Loyalty +10 (89 → 99); bond 20 → 40 (+2 a turn). Cost: 1 DP. → display-only
...
---
finished: **completed** · commands 200 · popups 46 · battles 11
