...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/commands/combat_executor.py:3195`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/game_logic/vassal.py:860`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/game_logic/settlement_offers.py:2696`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/game_logic/settlement_offers.py:2714`
...
**Verdict:** AUTHOR-VERIFIED (hand-reproduced this session) · **Seam:** `backend/main.py:1355`
...
**Verdict:** AUTHOR-VERIFIED (hand-reproduced this session) · **Seam:** `backend/ai/clause_guards.py:77`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/ai/enemy_ai.py:3521`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/commands/movement_executor.py:588`
...
**Verdict:** AUTHOR-VERIFIED (hand-reproduced this session) · **Seam:** `backend/commands/naval_executor.py:95`
...
**Verdict:** AUTHOR-VERIFIED (hand-reproduced this session) · **Seam:** `backend/game_logic/dispatch.py:919`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/commands/strategic_executor.py:837`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/commands/strategic.py:2940`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/commands/strategic.py:2583`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/commands/strategic.py:874`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/models/world_state.py:10116`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/models/dialogue_manager.py:779`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/commands/strategic.py:2860`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/commands/strategic_executor.py:2153`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/game_logic/ai_diplomacy.py:896`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/commands/parser.py:1074`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/commands/combat_executor.py:3148`
...
**Verdict:** AUTHOR-VERIFIED (hand-reproduced this session) · **Seam:** `backend/commands/executor.py:719`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/game_logic/dispatch.py:742`
...
**Verdict:** AUTHOR-VERIFIED (hand-reproduced this session) · **Seam:** `backend/models/world_state.py:6206`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/ai/enemy_ai.py:1835`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/main.py:1620`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `godot-client/project-sovereign/scripts/main_menu.gd:527`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/main.py:3028`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/game_logic/naval.py:2091`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `godot-client/project-sovereign/scripts/main.gd:3295`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/game_logic/withdrawal.py:691`
...
**Verdict:** PLAUSIBLE (one refuter) · **Seam:** `backend/commands/strategic.py:817`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/ai/enemy_ai.py:2739`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/game_logic/dispatch.py:119`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `godot-client/project-sovereign/scripts/tutorial_overlay.gd:112`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `deploy/build.bat:61`
...
**Verdict:** AUTHOR-VERIFIED (hand-reproduced this session) · **Seam:** `backend/commands/disobedience.py:1512`
...
**Verdict:** PLAUSIBLE (one refuter) · **Seam:** `backend/ai/llm_client.py:899`
...
**Verdict:** PLAUSIBLE (one refuter) · **Seam:** `deploy/README_TESTER.txt:100`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `godot-client/project-sovereign/scripts/main_menu.gd:409`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/models/world_state.py:5399`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/game_logic/war_status.py:157`
...
**Verdict:** AUTHOR-VERIFIED (hand-reproduced this session) · **Seam:** `backend/game_logic/diplomatic_templates.py:3607`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/models/world_state.py:8419`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/commands/disobedience.py:1490`
...
**Verdict:** AUTHOR-VERIFIED (hand-reproduced this session) · **Seam:** `backend/commands/strategic.py:2262`
...
**Verdict:** UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands) · **Seam:** `backend/game_logic/diplomatic_dialogue.py:858`
...
`backend/game_logic/dispatch.py:273` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/game_logic/dispatch.py:1690` · PLAUSIBLE (one refuter)  
...
`godot-client/project-sovereign/scripts/war_detail_popup.gd:349` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`godot-client/project-sovereign/scripts/diplomatic_ledger.gd:846` · PLAUSIBLE (one refuter)  
...
`backend/game_logic/dispatch.py:806` · PLAUSIBLE (one refuter)  
...
`backend/ai/enemy_ai.py:1039` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/commands/combat_executor.py:8313` · UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands)  
...
`godot-client/project-sovereign/scripts/war_detail_popup.gd:108` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/game_logic/naval.py:597` · UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands)  
...
`backend/game_logic/diplomatic_dialogue.py:870` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/game_logic/diplomacy.py:4370` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/models/world_state.py:6330` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`backend/ai/llm_client.py:1598` · PLAUSIBLE (one refuter)  
...
`backend/game_logic/dispatch.py:57` · PLAUSIBLE (one refuter)  
...
`backend/game_logic/dispatch.py:233` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/ai/enemy_ai.py:5722` · UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands)  
...
`backend/game_logic/battle_report.py:748` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/ai/llm_client.py:1258` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/game_logic/ledger.py:411` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/game_logic/battle_report.py:836` · PLAUSIBLE (one refuter)  
...
`backend/commands/naval_executor.py:63` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`backend/commands/strategic_executor.py:1507` · PLAUSIBLE (one refuter)  
...
`backend/main.py:931` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`backend/commands/executor.py:727` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`godot-client/project-sovereign/scripts/interrupt_popup.gd:23` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`backend/commands/parser.py:45` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`backend/commands/naval_executor.py:207` · PLAUSIBLE (one refuter)  
...
`backend/commands/strategic.py:568` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`backend/game_logic/dispatch.py:1212` · UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands)  
...
`backend/commands/parser.py:525` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/commands/combat_executor.py:5028` · UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands)  
...
`backend/models/world_state.py:2884` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`godot-client/project-sovereign/scripts/main_menu.gd:444` · PLAUSIBLE (one refuter)  
...
`backend/game_logic/naval.py:1573` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`backend/game_logic/naval.py:1516` · PLAUSIBLE (one refuter)  
...
`backend/game_logic/ai_diplomacy.py:323` · PLAUSIBLE (one refuter)  
...
`backend/commands/combat_executor.py:1493` · PLAUSIBLE (one refuter)  
...
`godot-client/project-sovereign/scripts/main.gd:745` · UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands)  
...
`godot-client/project-sovereign/assets/maps/tutorial_1805.json:1` · UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands)  
...
`backend/commands/naval_executor.py:518` · UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands)  
...
`backend/game_logic/vassal.py:711` · PLAUSIBLE (one refuter)  
...
`backend/game_logic/dispatch.py:429` · UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands)  
...
`backend/commands/strategic.py:315` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`backend/commands/capture_executor.py:225` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`godot-client/project-sovereign/scripts/war_detail_popup.gd:439` · PLAUSIBLE (one refuter)  
...
`backend/commands/tactical_executor.py:480` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`godot-client/project-sovereign/scripts/popup_base.gd:40` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/commands/diplomatic_executor.py:686` · PLAUSIBLE (one refuter)  
...
`backend/models/cooldown_manager.py:146` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/save_manager.py:217` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`backend/game_logic/dispatch.py:1313` · PLAUSIBLE (one refuter)  
...
`backend/main.py:4079` · UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands)  
...
`backend/save_manager.py:240` · NARROWED (refuter corrected it; the corrected reading is what follows)  
...
`backend/main.py:4120` · UNVERIFIED (refuter budget exhausted; the finder's own cited evidence stands)  
...
`tools/playtest_driver.py:932` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:621` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:525` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:1271` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_scripts/tutorial_lesson.json:9` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:1176` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:1100` · HARNESS (author-checked, no refuter)  
...
`tests/data/parser_golden_corpus.json:3462` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`tools/playtest_driver.py:1323` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:816` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:699` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:1069` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:152` · HARNESS (author-checked, no refuter)  
...
`backend/commands/diplomatic_executor.py:3421` · AUTHOR-VERIFIED (hand-reproduced this session)  
...
`tools/playtest_driver.py:1392` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_scripts/naval_descent.json:7` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:236` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:446` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:745` · HARNESS (author-checked, no refuter)  
...
`godot-client/project-sovereign/scripts/tutorial_overlay.gd:297` · HARNESS (author-checked, no refuter)  
...
`tests/test_serialization_enforcement.py:389` · HARNESS (author-checked, no refuter)  
...
`tools/mutation_sweep.py:84` · HARNESS (author-checked, no refuter)  
...
`tools/playtest_driver.py:1353` · HARNESS (author-checked, no refuter)  
