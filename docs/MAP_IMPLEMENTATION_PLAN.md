...
(Review-outcome list updated from six to nine amendments: the June 22 scenario-setup follow-up (7), the second independent verification pass (8), and the third independent verification pass (9).)
