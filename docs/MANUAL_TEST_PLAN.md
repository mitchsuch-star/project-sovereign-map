...
### DP10. Continental System

#### DP10A. Activate Continental System

```
/debug set_relation France Prussia ALLIANCE
activate continental system
```

**Expected:**
- DP cost deducted
- Continental System members list updated
- Strategic ledger Economy tab shows trade impact
- Morning dispatch mentions Continental System

#### DP10B. Effect on British income
...
**Expected:**
- Britain's naval trade income reduced
- Effect visible in diplomatic ledger or advisory
- More members = greater reduction
