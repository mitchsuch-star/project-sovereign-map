...
| Force alliance in peace deal | +15 | On ratification of `forced_alliance` clause (WAR_PURPOSE_SCORE_SEMANTICS_SPEC.md §9.6) | Forced alignment alarms courts without outright conquest |
