...
>
> **This pass's place in the queue.** The audit runs on a **known-green master** *before* the Economy build (`ECONOMY_REVISIT_SPEC.md`), so play-feel isn't muddied by economy churn and the economy tab you assess is the current one. Its two capstones feed forward: the **creative / fun-factor memo (§8)** and the dedicated **economy evaluation** it flows into (`ECONOMY_REVISIT_SPEC.md §0.7`) — where you carry your fresh, whole-codebase familiarity into an independent read of the economy recommendations *before* any of that code is written. See §11.
...
Close the audit with the §9 final report, then open `ECONOMY_REVISIT_SPEC.md §0.7`.
