...
> `SPOKEN_BLOCKER_PHRASES` (the 8 negative-capable acceptance components as spoken
> clauses) + per-register leaning/holds-out framings on the LIVE ally-petition suffix
