...
> The last question is why **FA-N17 and FA-N23 exist: they are defects in the
> audit's own fix shapes** (FA-4's and FA-7's), which would have shipped as
> regressions from rows this pass otherwise confirmed.
>
...
>
> **The four P1s:** a negated answer to any pending dialogue executes the
...
> (**FA-N4**); and two blocking client modals answer whichever dialogue is on top
> of the stack, sending no W6-0 identity at all (**FA-N5**).
