...
> The last question is why **FA-N17, FA-N23, FA-N38 and FA-N51 exist: they are
> defects in the audit's own fix shapes** — FA-4's, FA-7's, FA-27's and FA-21's —
> which would have shipped as regressions from rows this pass otherwise confirmed.
>
> ⚠ **This table is a FLOOR, not a census.** 43 surviving rows were queued for a
> sweep and only 22 finished before the pass closed; those averaged ~2.6 confirmed
> findings each. The workflow is resumable.
>
