...
>
> ⚠ **This table is a FLOOR, not a census.** 43 surviving rows were queued for a
> sweep and 30 finished before the pass closed, averaging ~2.3 confirmed findings
> each. The workflow is resumable.
>
