...
> game rows and both halves of WIN-H1 are FIXED, and the **WIN-D2 design
> question was RULED and BUILT** — see `DESIGN_REFINEMENT.md`
> §Win-Attempt Campaign for the gate record. Pins:
> `tests/test_win_campaign_fixes_2026_08_16.py` (22) +
> `tests/test_playtest_harness_win_campaign_2026_08_16.py` (17).
> Suite **18,096 / 3**; `BASELINE_SERIES` and M1–M7 byte-identical
