...
- Only after Slice F passes may manual Godot smoke begin. Required smoke:
  ...
  4. Incoming AI settlement offer if feasible, or a synthetic/debug staged offer if generation remains Slice G -> mailbox/offer route opens a settlement review surface and accept promotes through live revalidation to `settlement_confirm` without mutation; document any generation gap but keep the UI route guarded.
