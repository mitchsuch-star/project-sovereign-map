...
- **Peace Deals — BPH-A through BPH-D COMPLETE.** Term ownership, peace preview panel, fallout/commitment conflicts, ratification summary + dispatch. Next: **WPS-A** (War Purpose popup). See `docs/PEACE_DEALS_UMBRELLA_SPEC.md` + `docs/BILATERAL_PEACE_HARDENING_SPEC.md`.
