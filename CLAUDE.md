...
- **Wave 6 Fun-Factor Build** — **✅ APPROVED IN FULL July 10, 2026** (all capstone expansions + escalations + BUG-CA fixes, plus two gate additions: Dynamic Battle Naming and the Literal Doctrine — user steer: literal marshals need not object, the fantasy is "generals who do what they're ordered"). Build spec `docs/WAVE6_FUN_FACTOR_SPEC.md` (authoritative; blessed defaults tunable in-band, structural changes escalate). Supersedes R59/R153 literal-objection triggers.
