...
| Peace Deals / Imperial Settlement | **Active: `docs/SETTLEMENT_CONVERSATIONAL_REFRONT_SPEC.md` v0.6 (APPROVED May 29, 2026; Slice 0 + Slice 1 LANDED, Slice 2 next).** Cleanup gate is now `docs/SETTLEMENT_UI_CLEANUP_SPEC.md` **v0.32 GO** (SC-5R + SC-32/Slice G2 LANDED) with **Gate 4 smoke open**, then `docs/STATUS.md`. Older Imperial Settlement plan/spec docs remain historical anchors; do not route active work back to v0.19-v0.27, Slice F, Slice E, or a fresh G2-Slice-1 start. |
