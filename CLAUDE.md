...
| Peace Deals (umbrella + sub-specs) | **Next-up: `docs/SETTLEMENT_CONVERSATIONAL_REFRONT_SPEC.md` v0.5 + audit `docs/SETTLEMENT_CONVERSATIONAL_REFRONT_AUDIT.md` (conversational multi-party re-front — DESIGN GATE, finished + audited four times, 3rd/4th-run findings folded, needs user approval).** Current gate: `docs/SETTLEMENT_UI_CLEANUP_SPEC.md` v0.27 and `docs/STATUS.md`. Historical anchors: `docs/PEACE_DEALS_UMBRELLA_SPEC.md`, `BILATERAL_PEACE_HARDENING_SPEC.md`, `WAR_PURPOSE_SCORE_SEMANTICS_SPEC.md`, `WAR_BARGAIN_SPEC.md`, `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md`, and `WAR_SETTLEMENT_ALLY_PARTICIPATION_IMPLEMENTATION_PLAN.md`. Treat older Slice B / Final Gate notes as historical unless STATUS points back to them. |
