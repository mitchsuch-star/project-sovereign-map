...
- **Active next:** Special Abilities Evaluation (Davout's Iron Marshal ability — morale floor vs last stand defense bonus; review whether other marshals need wired abilities), then **Phase 7 Core** begins (Map Renderer is art-blocked, not a code blocker).
