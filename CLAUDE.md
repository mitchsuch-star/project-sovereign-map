...
- **Deep Audit Fix Plan — Sessions 1-6 DONE.** Session 1: 9 combat/war score fixes, 21 tests. Session 2: 18 vassal fixes, 27 tests. Session 3: 13 diplomatic state machine fixes, 25 tests. Session 4: 9 economy fixes, 16 tests. Session 5: 13 AI/parser/strategic fixes, 31 tests. Session 6: 10 popup/passthrough/security fixes (war declaration objection fields, path traversal, armistice notifications, stalled sabotage, debug guard), 19 tests. Sessions 7-9 remaining. See `docs/DEEP_AUDIT_FIX_PLAN.md`.
