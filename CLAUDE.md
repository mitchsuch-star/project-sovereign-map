...
| **Row REV follow-ups (the Aug 30, 2026 review's open items)** | **`docs/REV_FOLLOWUPS.md`** — three of four CLOSED Aug 31, 2026 (REV-V3 the rail census, REV-F1 the `battles_this_turn` wipe, REV-V4 both flow fixes staged and shot); **only UX23-R9 is open** — three bugle cues owe a human ear, rendered ready to play at `audition/ux23_r9/`. Landing record = `BUG_FIXES.md` §THE FOLLOW-UPS |
