...
- **Peace Deals — BPH-A through BPH-D + WPS-A COMPLETE.** Term ownership, peace preview panel, fallout/commitment conflicts, ratification summary + dispatch, War Purpose popup + objective state + ticking score. Next: **WPS-B** (power cap gating). See `docs/PEACE_DEALS_UMBRELLA_SPEC.md` + `docs/WAR_PURPOSE_SCORE_SEMANTICS_SPEC.md`.
