...
| Peace Deals (bilateral peace, war purpose, war bargains) | `docs/PEACE_DEALS_UMBRELLA_SPEC.md` (dependency graph, gates, cross-cutting decisions — read FIRST), then the relevant sub-spec: `BILATERAL_PEACE_HARDENING_SPEC.md`, `WAR_PURPOSE_SCORE_SEMANTICS_SPEC.md`, `WAR_BARGAIN_SPEC.md`. WB §7.2/§9.2/§9.3 have been reconciled; if future wording drifts, umbrella §4.2 remains the live acceptance source of truth. |
...
| Peace Deals (umbrella + sub-specs) | `docs/PEACE_DEALS_UMBRELLA_SPEC.md` (dependency graph, gates, cross-cutting decisions), `BILATERAL_PEACE_HARDENING_SPEC.md`, `WAR_PURPOSE_SCORE_SEMANTICS_SPEC.md`, `WAR_BARGAIN_SPEC.md`, `WAR_SETTLEMENT_ALLY_PARTICIPATION_SPEC.md` (deferred follow-up) |
