...
- **Settlement UI Cleanup G2-Slice-5 — LANDED May 7, 2026 (Presentation & Metadata).** Active next gate is **Gate 4 manual Godot smoke** (10-step script in `docs/SETTLEMENT_UI_CLEANUP_SPEC.md` §Gate 4), then Slice G AI/ally settlement agency.
...
- **Peace Deals - Phase A COMPLETE, Gate 1 PASSED. WB-A/WB-B/WB-C/WB-D COMPLETE. Imperial Settlement Slices A1–E + Slice F UI routing LANDED. Settlement UI Cleanup Spec is NEXT.** `docs/SETTLEMENT_UI_CLEANUP_SPEC.md` v0.17 is the mandatory quality gate before Slice G, manual smoke, or the Final Gate. See work order above.
