...
- **Peace Deals - Settlement UI Cleanup v0.22 repair + Deferred Work Landing Ledger + Gate 4 smoke is up next.** G2-Slice-1 through G2-Slice-5 are already landed for current routing. The remaining player-readiness gate is to consume the v0.22 repair contract in `docs/SETTLEMENT_UI_CLEANUP_SPEC.md`, verify STATUS/SC-27 scans, verify the SC-29 / SC-30 / SC-31 / SC-32 landing ownership check, verify Voice Bible 16.1 anchors, then run Gate 4 manual smoke including the rejected/losing concession path. Slice G remains blocked until those checks and smoke evidence are recorded.
