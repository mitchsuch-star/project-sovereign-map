...
- **Peace Deals — Phase A COMPLETE, Gate 1 PASSED.** BPH-A through BPH-D + WPS-A through WPS-D all landed. Gate 1 verified (9/9 smoke criteria). `threat_coalition` retirement decided: retire before WB-A. Next: `threat_coalition` cleanup pass, then WB-A. See `docs/PEACE_DEALS_UMBRELLA_SPEC.md` + `docs/WAR_PURPOSE_SCORE_SEMANTICS_SPEC.md`.
