...
- **Peace Deals — BPH-A through BPH-D + WPS-A + WPS-B + WPS-C COMPLETE.** Term ownership, peace preview panel, fallout/commitment conflicts, ratification summary + dispatch, War Purpose popup + objective state + ticking score, vassalage power cap, forced alliance + liberation are landed. See `docs/PEACE_DEALS_UMBRELLA_SPEC.md` + `docs/WAR_PURPOSE_SCORE_SEMANTICS_SPEC.md`.
