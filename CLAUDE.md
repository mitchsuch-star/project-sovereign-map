...
**Phase 6.2 Economy: 6.2.A-B COMPLETE** (region types, differentiated income, per-nation gold, upkeep, bankruptcy, admin AP). Next: **Phase 6.2.C Stability + War Damage**. See `docs/ROADMAP.md` for EA readiness roadmap.
