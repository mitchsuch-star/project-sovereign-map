...
- **Peace Deals — BPH-A through BPH-D + WPS-A through WPS-D COMPLETE.** Term ownership, peace preview panel, fallout/commitment conflicts, ratification summary + dispatch, War Purpose popup + objective state + ticking score, vassalage power cap, forced alliance + liberation, war score legibility + AI + surface polish are landed. WPS phase complete. Next: Gate 1 verification or WB-A. See `docs/PEACE_DEALS_UMBRELLA_SPEC.md` + `docs/WAR_PURPOSE_SCORE_SEMANTICS_SPEC.md`.
