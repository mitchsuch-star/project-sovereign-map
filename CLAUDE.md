...
| **Row REV follow-ups (the Aug 30, 2026 review's open items)** | **`docs/REV_FOLLOWUPS.md`** — REV-V3 (33 unmapped rail rows), REV-F1 (`battles_this_turn` wipe, plausible-only), REV-V4 (two flow fixes never staged on screen), UX23-R9 (three bugle cues owe a human ear) |
