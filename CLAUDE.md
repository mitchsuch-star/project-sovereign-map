...
- **Command Robustness** — v0.2 scope BLESSED July 3, 2026 (CR-0..CR-5); **CR-5 detailed scope BLESSED July 5, 2026 (spec §6); Flavor Echoing promoted to owned slice CR-5b.** CR-6 needs a dedicated gate. `docs/COMMAND_ROBUSTNESS_SPEC.md`
